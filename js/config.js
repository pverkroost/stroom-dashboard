...
const APPARATEN = [
  { naam: 'Auto (PHEV)',             icon: VOLVO_SVG, uren: 6,   vermogen: 2.3, type: 'laden',       automatisering: true,  volgorde: 1, grootverbruik: false },
  { naam: 'Warmtepomp (warm water)', icon: '♨️',       uren: 2,   vermogen: 2.0, type: 'inschakelen', automatisering: false, volgorde: 6, grootverbruik: true,  opmerking: 'buffert warm water, niet voor verwarming' },
  { naam: 'Wasmachine',              icon: '👕',       uren: 2,   vermogen: 1.5, type: 'starten',     automatisering: false, volgorde: 3, grootverbruik: true,  comboMet: 'Droger' },
  { naam: 'Droger',                  icon: '🌀',       uren: 2,   vermogen: 2.5, type: 'starten',     automatisering: false, volgorde: 4, grootverbruik: true,  naApparaat: 'Wasmachine' },
  { naam: 'Vaatwasser',              icon: '🍽️',      uren: 3.5, vermogen: 1.8, type: 'starten',     automatisering: false, volgorde: 2, grootverbruik: true  },
  { naam: 'E-bikes (2x)',            icon: '🚲',       uren: 4,   vermogen: 0.2, type: 'laden',       automatisering: false, volgorde: 5, grootverbruik: false },
  { naam: 'Boiler kantoor',          icon: '🚿',       uren: 1,   vermogen: 2.5, type: 'inschakelen', automatisering: false, volgorde: 7, grootverbruik: true  },
  { naam: 'Airco',                   icon: '❄️',       uren: 3,   vermogen: 2.0, type: 'inschakelen', automatisering: false, volgorde: 8, grootverbruik: true  },
];
