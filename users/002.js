...
(function() {
  window.CONFIG = {
    ...
    apparaten: [
      { naam: 'Auto (PHEV)',             icon: '🚗',       uren: null, vermogen: null, type: 'laden',       automatisering: false, batterij: true,  volgorde: 1, grootverbruik: false, klaarOmTekst: 'Auto moet opgeladen zijn om',       korteTekst: '🔋 Opgeladen zijn om', autoInfo: { merk: 'onbekend', type: 'PHEV', bouwjaar: null, batterijKwh: null, laadVermogenKw: null } },
